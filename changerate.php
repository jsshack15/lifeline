...
.file-input-wrapper:hover > .btn-file-input {
   ...
   data: {nrate:$("#nrate").val(),id:$("#id").val()},
   ...
   async:true
						 ...
						 <h2 style="text-align:left;">New Rate</h2>
						<div class="row uniform 50% ">
									<div class="6u 12u$(xsmall)";">
									<input type="hidden" name="id" id="id" value="<?php echo $editid;?>" />
										<input type="text" name="nrate" id="nrate" value="" placeholder="Enter New Rate" required/>
										
									</div>
									<div class="6u$ 12u$(xsmall)">
										<button onclick="save()" id="changerate"class="button">Change</button>
									</div>
