...
echo'<tr><td><a style="text-decoration:none;"href="lab.php?id='.$result[5].'#one"><i class="fa fa-flask"></i>&nbsp;&nbsp;'.$labn.'</a></td><td>'.$result[3].'</td><td><strong style="color:green;">'.$result[1].'</strong> /10</td><td><img height="20" width="20"src="images/'.$result[2].'.png"></img></td><td><strong style="color:green;">'.$result[4].'</strong></td></tr>';
