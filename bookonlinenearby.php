...
$sql8=mysql_query("select address from labbranch where labname='$lname'");
$show=mysql_fetch_row($sql8);
         ...
         <p >For help : +91-9717-06-5383</p>
				...
				<div class="6u$ 12u$(xlarge)">
								     <table style="list-style:none;text-align:center;">
										...
										<tr><td style="font-weight:bold;">LAB &nbsp;&nbsp;&nbsp;&nbsp;  :</td> <td style="font-weight:bold;"> <span style="font-size:20px;color:green;"><?php echo $lname;?></span></td></tr>
										<tr><td style="font-weight:bold;">ADDRESS &nbsp;&nbsp;&nbsp;&nbsp;  :</td> <td style="font-weight:bold;"> <span style="font-size:20px;color:green;"><?php echo $show[0];?></span></td></tr>
									</table>
   								    
									</div>
									
				                    
									<input type="hidden" name="labname" id="labname" value="<?php echo $lname;?>" />
									
				<input type="hidden" name="time" id="time" value="<?php print date("h:i:s a");?>" />
									...
									<div class="6u 12u$(xlarge)">
										...
										<div class="select-wrapper">
											<select name="tname" id="tname">
												...
												<?php
												$hub=mysql_query("select tname from testnames where labname='$lname'");
												while($dat=mysql_fetch_row($hub))
												{
...
function book(){
 ...
 $.ajax({
         type:"post",
   url: "bookajaxnearby.php",
   
   data: {name:$("#name").val() ,phone:$("#phone").val(), address:$("#address").val(),tname:$("#tname").val(),labname:$("#labname").val(),time:$("#time").val(),date:$("#date").val(),email:$("#email").val()},
